		                ...
		                <div class="col-xs-9">
		                    ...
		                    <div style="width:100%;border-top:1px solid silver">
		                        ...
		                        <ul>
		                            ...
		                            <li>Discount:   <?php echo $mobile->Price-($mobile->Price*$mobile->DiscountRate)/$mobile->Price." Rs"?></li>
		                            <li>Price:   <?php echo $mobile->DiscountRate?></li>
		                            ...
		                            <li>Processor:   <?php echo $mobile->CPU?></li>
									
										<a href="buy.php"><button class = "buy" type="submit">BUY</button></a>
